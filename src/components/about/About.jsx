...
const About = () => {
  ...
  return (
    <div className="flex flex-col w-screen 3xl:w-screen 3xl:h-799 items-center opacity-100 bg-gray-medium p-0">
      ...
      <p className="w-10/12 2xl:w-7/12 2xl:h-44 text-center tracking-normal text-text opacity-100 text-xl lg:text-2xl xl:text-3xl 2xl:text-3xl leading-9 text-pharagrap mt-8 2xl:mt-24">The hardest part is getting started, the rest we will build together, I can help you connect with the world through your web app. I'm excited to work with you and bring your ideas to life</p>
      <p className="w-10/12 2xl:w-2/4 2xl:h-20 text-center tracking-normal text-text opacity-100 text-xl lg:text-2xl 2xl:text-3xl xl:text-3xl leading-9 text-pharagrap font-bold mt-8">Let's talk about your new project over a cup of coffee.</p>
