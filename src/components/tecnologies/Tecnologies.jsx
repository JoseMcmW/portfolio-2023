...
const Tecnologies = ({ techSkills }) => {
  ...
  return (
    <div className="3xl:w-screen h-575 bg-gray-dark opacity-100 relative">
      {!isSkillsVisible && (
        <>
          <img src="../../../public/img/uparrow.svg" alt="up-arrow" className="w-119 h-40 opacity-100 absolute left-679px top-36 transform -rotate-2 scale-x-1.05 animate-bounce animate-thrice"/>
          ...
          <img src="../../../public/img/downarrows.svg" alt="down-arrow" className="w-119 h-40 opacity-100 absolute left-1096px top-320px transform rotate-7 scale-99 animate-bounce animate-thrice"/>
        </>
      )}
      {isSkillsVisible && (
